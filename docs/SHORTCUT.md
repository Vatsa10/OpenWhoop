...
and hands it back to the OpenWhoop PWA via `x-callback-url`. This is the
...
3. Opens that URL → which pops your OpenWhoop tab back into focus with the
...
In the OpenWhoop panel tap **Pull from iPhone**. Safari/Bluefy → Shortcuts
