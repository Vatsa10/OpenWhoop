# openwhoop v0.3 — Browser PWA

Date: 2026-05-20
Status: design approved, ready for implementation plan
Supersedes (in part): `2026-05-20-openwhoop-redesign-design.md` (v0.2 Python+Mac dashboard)
...
|---|---|
| `openwhoop/db.py` (SQLite + helpers) | Replaced by `web/js/data/db.js` (IndexedDB) |
| `openwhoop/dashboard.py` (HTTP API) | API routes deleted; static-file serving kept |
| `openwhoop/recorder.py` (background BLE) | Deleted — browser does BLE |
| `openwhoop/metrics.py` (HRV/recovery/strain) | Ported → `web/js/metrics/{hrv,recovery,strain}.js` |
| `openwhoop/sleep.py` | Ported → `web/js/metrics/sleep.js` |
| `openwhoop/zones.py` | Ported → `web/js/metrics/zones.js` |
| `openwhoop/workouts.py` | Ported → `web/js/metrics/workouts.js` |
| `openwhoop/cli.py` | Trimmed to `dash` only |
...
- `openwhoop/recorder.py`, `openwhoop/db.py`, `openwhoop/metrics.py`, `openwhoop/sleep.py`, `openwhoop/zones.py`, `openwhoop/workouts.py`
